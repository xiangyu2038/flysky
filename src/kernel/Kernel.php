<?php
namespace XiangYu2038\FlySky\kernel;
...
class Kernel implements HttpKernelInterface, TerminableInterface
{
    ...
    public function __construct(DispatcherContract $dispatcher, ControllerResolverInterface $resolver, RequestStack $requestStack = null, ArgumentResolverInterface $argumentResolver = null)
    {
    ...
    private function handleRaw(Request $request, int $type = self::MASTER_REQUEST)
    {
        ...
        // request
        $event = new GetResponseEvent($this, $request, $type);//事件
